...
describe('POST /signup', () => {
  ...
  it('should successfully create a user and redirect to login', async () => {
    db.query
    ...
    const response = await request(app)
      .post('/signup')
      .send({ name: 'John Doe', email: 'johnd@example.com', password: 'Password2!', profileImage: 'url/to/image' });
